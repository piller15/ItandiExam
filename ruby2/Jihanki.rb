require_relative 'Drink/SoftDrink'
require_relative 'Drink/EnergyDrink'
require_relative 'Drink/Water'
...
class Jihanki
    ...
    def initialize
        @juice_list =   [
                            SoftDrink.new("cola", 120, 5), 
                            EnergyDrink.new("red bull", 200, 5),
                            Water.new("water", 100, 5)
                        ]
        @money      = 0
        @sales      = 0
    end #end initialize
